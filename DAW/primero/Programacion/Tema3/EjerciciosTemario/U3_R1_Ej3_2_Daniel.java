...
public class U3_R1_Ej3_2_Daniel{
	...
	if(alumnos!=0){
		media=suma/alumnos;
		System.out.printf("La suma total de las edades es: %d.%nSu media es: %.2f.%nLa cantidad de alumnos introducidos es: %.0f.%nLa cantidad de alumnos mayores de edad es: %d.%n",suma,media,alumnos,mayores);
	}else{
